...
# В прошлый раз мы говорили про "масштабирование Humanities"
### В ближайшие несколько занятий сосредоточимся на текстах
...
1. Использовать готовые корпуса с готовым интерфейсом (Google Books, НКРЯ, Sketch Engine и т.п.).

![war](pics/war.jpg)

Про культуромику мы еще немножко поговорим. А вот приме
