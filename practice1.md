...
💻 Задание: если вы никогда этого не делали — загрузите, пожалуйста, в Voyant любой крупный (не менее 50 кб) txt-файл. Можете создать сами, найти у себя, в крайнем случае — возьмите [этот](data/Dostoevsky_PrestuplenieINakazanie.txt).
...
* Возможность загрузить словарь лемм (вот такой), чтобы тексты лемматизировались прямо внутри программы
